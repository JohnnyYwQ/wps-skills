...
class RequestTiming:
    def __init__(self, journal, *, clock=time.perf_counter_ns):
...
@contextmanager
def submission(enabled=True, *, journal=None, clock=time.perf_counter_ns):
    ...
    recorder = RequestTiming(journal, clock=clock)
