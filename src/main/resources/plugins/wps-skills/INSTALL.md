...
更多操作说明见 [插件使用说明](plugins/wps-skills/README.md)。安装方式参考 [Codex 官方文档](https://developers.openai.com/plugins/build/plugins) 和 [Claude Code 官方文档](https://code.claude.com/docs/en/plugin-marketplaces)。
