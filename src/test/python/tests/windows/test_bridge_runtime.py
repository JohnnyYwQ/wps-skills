...
from wps_skills.windows.bridge_runtime import (
    LazyWindowsBridge,
...
class LazyWindowsBridgeTests(unittest.TestCase):
    @patch("wps_skills.windows.bridge_runtime.Path.is_file", autospec=True)
    @patch.dict(
        "wps_skills.windows.bridge_runtime.os.environ",
        {"WINDIR": r"C:\Windows"},
    )
