...
- `main.js`：轮询 Python Runner、分发 WPS Action 并包含现有行为实现。Excel 切片覆盖核心数据以及格式、图表、分析、透视、保护、图片和上下文能力；Word 切片覆盖文档生命周期、内容、范围、模板、格式、书签、批注与修订能力；PowerPoint 核心切片覆盖演示文稿、幻灯片、文本、图片、表格、备注与基础版式。成功结果遵循 Action manifest，WPS 异常返回失败结果。
